...
<div class="card">
    ...
    <div class="card-content">
        ...
        <div class="card-title">{{ trans('Products::default.titles.add') }}</div>

        <div class="row">

            <div class="input-field col s4">
                {{ Form::select('category_id',['1'=>'Demo1','2'=>'Demo2'],null, ['placeholder' => 'Please select category','class' => 'form-control border-input']) }}
            </div>
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="file-field input-field col s6">
                                    ...
                                    <div class="btn z-depth-0"><span>File</span>
                                        {{ Form::file('data['.$lang->id.'][upload]') }}</div>
                                    <div class="file-path-wrapper">
                                        <input class="file-path validate" type="text" placeholder="@if(!Request::segment(4) == 'edit') Upload one or more files @else {{ $model->photo }} @endif">
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="switch">
                                <label>
                                    Off
                                    {!! Form::checkbox('data['.$lang->id.'][status]',1, isset($model) ? $model->active : true) !!}
